...
/**
 * Contact / CTA section — motivating headline, sub-text, and a prominent
 * WhatsApp order button. Optionally shows Instagram handle.
 */
export function ContactSection({ config }: ContactSectionProps) {
  ...
  const waMessage = config.whatsappMessage ?? "Halo! Saya mau pesan kopi.";
  ...
  return (
    <>
      <section
        ...
        style={{
          background: `linear-gradient(135deg, ${primary} 0%, #4A2810 100%)`,
        }}
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "'Playfair Display', serif", color: secondary }}
          >
            {config.contactSectionTitle ?? "Yuk, Pesan Kopimu!"}
          </h2>

          {config.contactSectionSubtitle && (
            <p
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-base font-bold shadow-lg transition-all hover:scale-105 hover:shadow-xl active:scale-95"
      ...
      <footer
        ...
        style={{ background: "#1C1007", color: "rgba(245,230,200,0.5)" }}
      >
        {footerText}
      </footer>
    </>
